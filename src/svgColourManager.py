...
class SvgColourManager:
    ...
    # blanks (sets "fill=None") the elements in the list. Useful for borders
    # etc.
    ...
    def editMap(self):
        ...
        # Assembles output line, inserting CSS style instructions between
        # header and body of the SVG file.
